...
class ACUDPClient:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Connesso: Pilota: {self.driver_name} | Auto: {self.car_name} | Pista: {self.track_name}"
            )
        ...
        try:
            if (
                ...
                telemetry = {
                    ...
                    "gear": int(unpacked[23])
                    - 1,  # AC invia: 0=R, 1=N, 2=1a marcia. Sottraendo 1 abbiamo -1=R, 0=N, 1=1a
